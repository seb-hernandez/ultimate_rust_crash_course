...
fn main() {
    ...
    for arrow_coord in arrow_coords {
        ...
        // let value = arrow_coord.distance_from_center();
        //
        // if value < 1.0 { shots.push(Shot::Bullseye) }
        // if value >= 1.0 && value <= 5.0 { shots.push(Shot::Hit(value)) }
        // if value > 5.0 { shots.push(Shot::Miss) }
    }
